...
export const AnimalFindFirstOrThrowSelectSchema: z.ZodType<Prisma.AnimalSelect> = z.object({
...
export const AnimalFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    age: z.boolean().optional(),
    species: z.boolean().optional(),
...
export const AnimalFindFirstOrThrowSchema: z.ZodType<Prisma.AnimalFindFirstOrThrowArgs> = z.object({ select: AnimalFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AnimalIncludeObjectSchema.optional()), orderBy: z.union([AnimalOrderByWithRelationInputObjectSchema, AnimalOrderByWithRelationInputObjectSchema.array()]).optional(), where: AnimalWhereInputObjectSchema.optional(), cursor: AnimalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AnimalScalarFieldEnumSchema, AnimalScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AnimalFindFirstOrThrowArgs>;

export const AnimalFindFirstOrThrowZodSchema = z.object({ select: AnimalFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => AnimalIncludeObjectSchema.optional()), orderBy: z.union([AnimalOrderByWithRelationInputObjectSchema, AnimalOrderByWithRelationInputObjectSchema.array()]).optional(), where: AnimalWhereInputObjectSchema.optional(), cursor: AnimalWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AnimalScalarFieldEnumSchema, AnimalScalarFieldEnumSchema.array()]).optional() }).strict();