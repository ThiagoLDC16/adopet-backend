...
import { AnimalsCharacteristicsAnimalIdCharacteristicIdCompoundUniqueInputObjectSchema as AnimalsCharacteristicsAnimalIdCharacteristicIdCompoundUniqueInputObjectSchema } from './AnimalsCharacteristicsAnimalIdCharacteristicIdCompoundUniqueInput.schema'

const makeSchema = () => z.object({
  animalId_characteristicId: z.lazy(() => AnimalsCharacteristicsAnimalIdCharacteristicIdCompoundUniqueInputObjectSchema).optional()
}).strict().superRefine((obj, ctx) => {
        const presentTop = (k: string) => (obj as any)[k] != null;
        const singles: string[] = [] as string[];
        const groups: string[][] = [["animalId","characteristicId"]] as string[][];
...
export const AnimalsCharacteristicsWhereUniqueInputObjectSchema: z.ZodType<Prisma.AnimalsCharacteristicsWhereUniqueInput> = makeSchema() as unknown as z.ZodType<Prisma.AnimalsCharacteristicsWhereUniqueInput>;
export const AnimalsCharacteristicsWhereUniqueInputObjectZodSchema = makeSchema();
