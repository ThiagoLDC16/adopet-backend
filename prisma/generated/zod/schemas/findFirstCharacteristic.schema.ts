...
export const CharacteristicFindFirstSelectSchema: z.ZodType<Prisma.CharacteristicSelect> = z.object({
...
export const CharacteristicFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    description: z.boolean().optional(),
    animals: z.boolean().optional(),
    _count: z.boolean().optional()
