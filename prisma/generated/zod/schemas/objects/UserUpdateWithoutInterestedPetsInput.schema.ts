...
const makeSchema = () => z.object({
  ...
  notificacoesAtivas: z.lazy(() => NotificationUpdateManyWithoutUserNestedInputObjectSchema).optional(),
  ownedPets: z.lazy(() => AnimalUpdateManyWithoutResponsibleNGONestedInputObjectSchema).optional()
}).strict();
export const UserUpdateWithoutInterestedPetsInputObjectSchema: z.ZodType<Prisma.UserUpdateWithoutInterestedPetsInput> = makeSchema() as unknown as z.ZodType<Prisma.UserUpdateWithoutInterestedPetsInput>;
export const UserUpdateWithoutInterestedPetsInputObjectZodSchema = makeSchema();
