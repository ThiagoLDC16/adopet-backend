...
const makeSchema = () => z.object({
  ...
  notificacoesAtivas: z.lazy(() => NotificationUncheckedCreateNestedManyWithoutUserInputObjectSchema).optional(),
  ownedPets: z.lazy(() => AnimalUncheckedCreateNestedManyWithoutResponsibleNGOInputObjectSchema).optional()
}).strict();
export const UserUncheckedCreateWithoutInterestedPetsInputObjectSchema: z.ZodType<Prisma.UserUncheckedCreateWithoutInterestedPetsInput> = makeSchema() as unknown as z.ZodType<Prisma.UserUncheckedCreateWithoutInterestedPetsInput>;
export const UserUncheckedCreateWithoutInterestedPetsInputObjectZodSchema = makeSchema();
