...
export const AnimalsCharacteristicsFindFirstSelectSchema: z.ZodType<Prisma.AnimalsCharacteristicsSelect> = z.object({
...
export const AnimalsCharacteristicsFindFirstSelectZodSchema = z.object({
    animalId: z.boolean().optional(),
    characteristicId: z.boolean().optional(),
    animal: z.boolean().optional(),
    characteristic: z.boolean().optional()
...
export const AnimalsCharacteristicsFindFirstSchema: z.ZodType<Prisma.AnimalsCharacteristicsFindFirstArgs> = z.object({ select: AnimalsCharacteristicsFindFirstSelectSchema.optional(), include: z.lazy(() => AnimalsCharacteristicsIncludeObjectSchema.optional()), orderBy: z.union([AnimalsCharacteristicsOrderByWithRelationInputObjectSchema, AnimalsCharacteristicsOrderByWithRelationInputObjectSchema.array()]).optional(), where: AnimalsCharacteristicsWhereInputObjectSchema.optional(), cursor: AnimalsCharacteristicsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AnimalsCharacteristicsScalarFieldEnumSchema, AnimalsCharacteristicsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.AnimalsCharacteristicsFindFirstArgs>;

export const AnimalsCharacteristicsFindFirstZodSchema = z.object({ select: AnimalsCharacteristicsFindFirstSelectSchema.optional(), include: z.lazy(() => AnimalsCharacteristicsIncludeObjectSchema.optional()), orderBy: z.union([AnimalsCharacteristicsOrderByWithRelationInputObjectSchema, AnimalsCharacteristicsOrderByWithRelationInputObjectSchema.array()]).optional(), where: AnimalsCharacteristicsWhereInputObjectSchema.optional(), cursor: AnimalsCharacteristicsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([AnimalsCharacteristicsScalarFieldEnumSchema, AnimalsCharacteristicsScalarFieldEnumSchema.array()]).optional() }).strict();